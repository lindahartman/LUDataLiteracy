...
This document contain a solved version of the first practical on **Data Visualization with Plotnine**.
...
Getting confident with building code is - surprise! -  achieved by practicing! To provide enough possibilities for practice our tutorials will be longer than what we expect that (any of) you to fit into the 2 hours. You can consider the challenges on the Utrecht data as the basis, and the challenges for the King's county as an (optional) repetition of the concepts. 



# Pair programming

Before you begin your pair-programming session, decide who starts as *Driver* and who is first *Navigator*. 



## Preparation: 
### Navigator's computer 
Please open the files you need for reference, they will be the navigator's best tools to help the driver efficiently:

- Open your self-created code-along notebook with the commands you tried during the preparatory videos. 
- Keep [this document](https://lindahartman.github.io/LUDataLiteracy/1_DataViz.html) on the screen
- Open [data dictionary](https://lindahartman.github.io/LUDataLiteracy/Utrecht.html) for Utrecht data  
- Have a look at the [manuscripts for the preparatory videos](https://dmi3kno.github.io/DATA24/visualization.html). Although, texts are rather chatty, the code (and explanations) can be useful!
...
| :bulb: Plot bathrooms as a 'factor' to show the two categories more distinctly.
:::
...
| :bulb: `facet_wrap`could be of good help here!
...
| :bulb: There is a variable for distance to train station in the data, see Utrecht Data Dictionary. 
...
| :bulb: You can directly plot a transformation including one or more variables, eg. `y='price/sqft_living'` for the price per square foot.
:::
